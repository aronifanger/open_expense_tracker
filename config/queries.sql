...
dados_com_ranking AS (
    SELECT
        ...
        ROW_NUMBER() OVER (PARTITION BY dados.cnpj ORDER BY dados.data DESC) as rn
    ...
    WHERE cnpj_basico in ('13193071', '15193908', '02435615', '02012862', '28800786', '28800786', '07575651', '02012862', '09590723', '26243349')
)
SELECT
    data,
    cnpj,
